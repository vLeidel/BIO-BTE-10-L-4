...
<div id="d7f5751d-7886-4769-99ab-500afed03e45" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_d7f5751d7886476999ab500afed03e45 = function() {
            ...
            var config = {};
            Plotly.newPlot('d7f5751d-7886-4769-99ab-500afed03e45', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_d7f5751d7886476999ab500afed03e45();
                };
